          ...
          <Form className="space-y-6">
            ...
            <div>
              ...
              <Field
                ...
                className={`w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${
                  touched.levelOfEducation && errors.levelOfEducation ? 'border-red-500' : 'border-gray-300'
                }`}
              >
            ...
            <div>
              ...
              <Field
                ...
                className={`w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${
                  touched.courseInterested && errors.courseInterested ? 'border-red-500' : 'border-gray-300'
                }`}
              >
                {courses.map((course) => (
